...
class Mapper {
    ...
    constructor(client, options) {
        ...
        this.#modelMappingInfos = ModelMappingInfo.parse(
            options,
            client.keyspace,
        );
        this.#modelMappers = new Map();
    }
     ...
     */
    forModel(name) {
        let modelMapper = this.#modelMappers.get(name);

        if (modelMapper === undefined) {
            let mappingInfo = this.#modelMappingInfos.get(name);
            ...
            this.#modelMappers.set(name, modelMapper);
        }
