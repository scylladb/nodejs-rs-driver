...
class ModelMappingInfo {
    ...
    getColumnName(propName) {
        const modelColumnInfo = this.#documentProperties.get(propName);
    ...
    newInstance() {
        return this.#mappings.newObjectInstance();
    }
    ...
    static #create(modelName, currentKeyspace, modelOptions) {
