...
const _table  = require("./table-metadata");
...
class Metadata {
    ...
    /**
     * Gets the keyspace metadata information.
    ...
    /**
     * Gets the metadata information of all the keyspaces.
     * @returns {Object.<String, KeyspaceMetadata>}
     */
    getKeyspaces() {
        // Planned implementation
        throw new Error("TODO: Not implemented");
