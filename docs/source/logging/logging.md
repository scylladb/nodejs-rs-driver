...
(there are few exceptions if you try to use client endpoint after shutdown).
...
configured severity are delivered to the listener. Filtering majority of the events happens on the
